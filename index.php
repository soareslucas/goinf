...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>GOinf | Gestão de Clientes e Serviços</title>
					...
					<div class="header-row">
						...
						<nav class="primary-menu">
							...
							<ul class="one-page-menu menu-container" data-easing="easeInOutExpo" data-speed="1250" data-offset="65">
								...
								<li class="menu-item">
									<a href="#" class="menu-link" data-href="#section-about"><div>Sobre</div></a>
								</li>
<!-- 								<li class="menu-item">
									<a href="#" class="menu-link" data-href="#section-works"><div>Projetos</div></a>
								</li> -->
								<li class="menu-item">
									<a href="#" class="menu-link" data-href="#section-services"><div>Serviços</div></a>
								</li>
<!-- 								<li class="menu-item">
									<a href="#" class="menu-link" data-href="#section-blog"><div>Blog</div></a>
								</li> -->
								<li class="menu-item">
									<a href="#" class="menu-link" data-href="#section-contact"><div>Contato</div></a>
								</li>
							</ul>
				...
				<div class="row mt-0 mt-md-5 clearfix">
					<div class="col-lg-6 my-5 my-md-0">
						<div class="heading-block border-bottom-0 bottommargin-sm">
							<h5 class="text-uppercase ls4 text-black-50 font-weight-light mb-2" data-animate="fadeInUp" data-delay="100">Solução para gerenciamento de clientes e serviços</h5>
							<h2 class="font-weight-bold nott font-secondary" data-animate="fadeInUp" data-delay="200" style="font-size: 58px; letter-spacing: -1px; color: #084678">Nós entregamos a melhor aplicação para você.</h2>
						</div>
						<p class="mb-5 lead" data-animate="fadeInUp" data-delay="400" style="line-height: 1.7;">Apps para plataforma web ou móvel de acordo com suas nessidades pessoas ou empresariais.</p>
						<a href="#" data-scrollto="#section-about" data-offset="70"  data-animate="fadeInUp" data-delay="600" class="button m-0 button-circle button-large text-white" style="background-color: #084678;">Começe aqui <i class="icon-line-arrow-right"></i></a>
					</div>
		...
		<section id="content">
			...
			<div class="content-wrap py-0" style="overflow: visible">
				...
				<div class="section-negetive mx-auto" style="max-width: 1000px; transform: translateY(-200px);">
					<div class="card-block-wrap no-gutters row align-items-stretch bg-white" style="border-radius: 20px; box-shadow: 0 10px 80px rgba(14,72,119, 0.2)">
						<div class="col-md-6 card-block" style="padding: 80px 70px;">
							<h5 class="ls3 text-uppercase font-weight-normal text-black-50 mb-3">Objetivo</h5>
							<h3 class="display-4 font-weight-bold font-secondary" style="color: #084678">Empresarial</h3>
							<p class="text-black-50 mb-5">Gerenciamento de clientes, pagamentos, portifólio de serviços e projetos totalmente sob demanda de novas contratações. </p>
							<a href="#" class="button m-0 button-circle button-large text-white" style="background-color: #084678;">Comece aqui</a>
						</div>
						<div class="line d-block d-md-none m-0"></div>
						<div class="col-md-6 card-block border-left" style="padding: 80px 70px;">
							<h5 class="ls3 text-uppercase font-weight-normal text-black-50 mb-3">Objetivo</h5>
							<h3 class="display-4 font-weight-bold font-secondary">Pessoal</h3>
							<p class="text-black-50 mb-5"> Controle seus assinantes bem como os pagamentos para cada pacote de conteúdo oferecido em sua própria plataforma.</p>
							<a href="#" class="button m-0 button-dark bg-black button-large button-circle">Comece aqui</a>
						</div>
					</div>
				</div>
				...
				<div id="section-about" class="center page-section">
					...
					<div class="container clearfix">
						...
						<h2 class="mx-auto bottommargin font-body" style="max-width: 700px; font-size: 40px;"> Uma ferramenta com acesso multiplataforma para todos os seus dispositivos.</h2>

						<p class="lead mx-auto bottommargin" style="max-width: 800px;"> Engaje seus clientes na descoberta do portifólio de produtos e serviços que você oferece, automatize as vendas permitindo que os novos contratantes assinem seu conteúdo ou solicite seus serviços.</p>

						<p class="bottommargin" style="font-size: 16px;"><a href="#" data-scrollto="#section-services" data-easing="easeInOutExpo" data-speed="1250" data-offset="70" class="more-link">Saiba mais <i class="icon-angle-right"></i></a></p>
				...
				<div id="section-works" class="page-section pt-0">
					...
					<div class="section m-0">
						<div class="container clearfix">
							<div class="mx-auto center" style="max-width: 900px;">
								<h2 class="mb-0 font-weight-light ls1">We create &amp; craft projects that ooze creativity in every aspect. We try to create a benchmark in everything we do. Take a moment to browse through some of our recent completed work.</h2>
							</div>
						</div>
					</div>
					...
					<div class="topmargin center"><a href="#" class="button button-border button-circle font-weight-semibold">View More Projects</a></div> 
				...
				<div id="section-services" class="page-section pt-0">
					...
					<div class="section m-0">
						<div class="container clearfix">
							<div class="mx-auto center" style="max-width: 900px;">
								<h2 class="mb-0 font-weight-light ls1"> Gostamos de trabalhar nos Serviços &amp; Produtos que fornecemos, tanto quanto você precisa deles. Isso nos ajuda a cumprir seus objetivos com facilidade. Navegue pela ampla gama de serviços que oferecemos. </h2>
							</div>
						</div>
					</div>
							...
							<div class="row align-items-stretch grid-border clearfix">
								...
								<div class="col-lg-4 col-md-6 col-padding">
									<div class="feature-box fbox-center fbox-dark fbox-plain">
										...
										<div class="fbox-content fbox-content-sm">
											<h3>Customizável para cada necessidade</h3>
										</div>
									</div>
								</div>
								<div class="col-lg-4 col-md-6 col-padding">
											...
											<div class="slider-wrap">
												<div class="slide">
													<div class="testi-content">
														<p>Se tu o desejas, podes voar, só tens de confiar muito em ti. </p>
				...
				<h2 class="text-center text-uppercase font-weight-light ls3 font-body">Recently From the Blog</h2>
							...
							<div class="form-widget">
								...
								<form class="row mb-0" id="contact" name="contact">
									...
									<div class="col-md-6 mb-4">
										<input type="text" id="template-contactform-name" name="nome" value="" class="sm-form-control border-form-control required" placeholder="Nome" />
									</div>
									<div class="col-md-6 mb-4">
										<input type="email" id="template-contactform-email" name="email" value="" class="required email sm-form-control border-form-control" placeholder="Endereço de Email " />
									</div>

									<div class="w-100"></div>

									<div class="col-md-4 mb-4">
										<input type="text" id="template-contactform-phone" name="telefone" value="" class="sm-form-control border-form-control" placeholder="Telefone" />
									</div>

									<div class="col-md-8 mb-4">
										<input type="text" id="template-contactform-subject" name="assunto" value="" class="required sm-form-control border-form-control" placeholder="Assunto" />
									</div>

									<div class="w-100"></div>

									<div class="col-12 mb-4">
										<textarea class="required sm-form-control border-form-control" id="template-contactform-message" name="mensagem" rows="7" cols="30" placeholder="Sua Mensagem"></textarea>
									</div>
						...
						<div class="col-md-4">
							...
							<div class="widget clearfix">
								...
								<ul class="list-unstyled footer-site-links mb-0">
									...
									<li><a href="#" data-scrollto="#section-about" data-easing="easeInOutExpo" data-speed="1250" data-offset="70">Sobre</a></li>
<!-- 									<li><a href="#" data-scrollto="#section-works" data-easing="easeInOutExpo" data-speed="1250" data-offset="70">Works</a></li>
 -->									<li><a href="#" data-scrollto="#section-services" data-easing="easeInOutExpo" data-speed="1250" data-offset="70">Serviços</a></li>
<!-- 									<li><a href="#" data-scrollto="#section-blog" data-easing="easeInOutExpo" data-speed="1250" data-offset="70">Blog</a></li>
 -->									<li><a href="#" data-scrollto="#section-contact" data-easing="easeInOutExpo" data-speed="1250" data-offset="70">Contato</a></li>
								</ul>
							</div>
						...
						<div class="col-md-4">
							...
							<div class="widget subscribe-widget clearfix" data-loader="button">
								<h4>Inscrição News Letter</h4>

								<div class="widget-subscribe-form-result"></div>
								<form id="widget-subscribe-form" action="include/subscribe.php" method="post" class="mb-0">
									<input type="email" id="widget-subscribe-form-email" name="widget-subscribe-form-email" class="form-control input-lg not-dark required email" placeholder="Seu Endereço de Email">
									<button class="button button-border button-circle button-light topmargin-sm" type="submit">Se Inscreva Agora</button>
								</form>
							</div>
						...
						<div class="col-md-4">
							...
							<div class="widget clearfix">
								...
								<p class="lead">Setor Bueno<br>Goiânia, GO 74215-140</p>
			...
			<div id="copyrights">
				<div class="container center clearfix">
					Copyrights GOINF 2021 | All Rights Reserved
				</div>
			</div>
	...
	<script src="https://maps.google.com/maps/api/js?key=AIzaSyD5nULZbkU5ERaNiY90RBgkHLLabiI-nCY&callback=initMap"></script>
